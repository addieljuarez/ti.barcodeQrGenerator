...
import ti.barcode.QRGContents;
import ti.barcode.QRGEncoder;
...
public class BarcodeModule extends KrollModule implements TiActivityResultHandler {
	...
	// Methods
	@Kroll.method
	public String generateCode(String textCode, int _width, int _height) {

		String inputValue = textCode;
		Bitmap bitmap;
		...
		if (inputValue.length() > 0) {
			...
			try {
				...
				//byte[] byteArray =  bitmap.toString();
			...
			return "not found text to convert";
		}
